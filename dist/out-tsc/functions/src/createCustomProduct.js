...
export const createCustomProduct = functions
    ...
    corsHandler(req, res, async () => {
        ...
        try {
            ...
            const { base64QRCode, originalProductId, userID } = req.body;
            ...
            const productResponse = await fetch(`${PRINTIFY_SHOP_URL}/shops/${shop_id}/products/${originalProductId}.json`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${api_token}`,
                },
            ...
            const updatePrintAreaList = (originalPrintAreas, uploadedImage, userID) => {
